...
const Contact = () => {
  ...
  const handleSend = (e) => {
    ...
    if (username === '') {
      ...
      emailjs
        .send(
          'service_vdy43fn', // Replace with your EmailJS service ID
          'template_rdov4a9', // Replace with your EmailJS template ID
          templateParams,
          '1fTaBaQ792c5_Bd_m' // Replace with your EmailJS user ID
        )
        .then(
          (response) => {
